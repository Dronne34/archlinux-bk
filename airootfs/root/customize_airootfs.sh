...
wget https://www.archlinux.org/logos/archlinux-icon-crystal-64.svg
cp -r archlinux-icon-crystal-64.svg /usr/share/pixmaps/archlinux-icon.svg
rm -r archlinux-icon-crystal-64.svg
wget https://orig00.deviantart.net/60cc/f/2016/234/f/2/arch_linux_wallpaper_dark_by_kjeksomanen-d4a70zy.png
cp -r arch_linux_wallpaper_dark_by_kjeksomanen-d4a70zy.png /usr/share/backgrounds/archlinux.png
rm -r arch_linux_wallpaper_dark_by_kjeksomanen-d4a70zy.png
